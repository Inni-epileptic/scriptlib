...
--just grass hat codes--
-- -gh 6203923527,4524991457,4820152700,4315489767,4458601937,4506945409,4794315940--
...
game.ReplicatedStorage.DefaultChatSystemChatEvents.SayMessageRequest:FireServer("[Scriptions Moonic Glitcher V7]: Welcome..  ", "All")
...
WingAnimTextBox.Name = "WingAnimTextBox"
...
if not getgenv().netrun then
    game:GetService("RunService").Stepped:Connect(function()
        settings().Physics.PhysicsEnvironmentalThrottle = Enum.EnviromentalPhysicsThrottle.Disabled
        settings().Physics.AllowSleep = false
        setsimulationradius(2^1920, 2^1080)
    end)
    getgenv().netrun = true
end
...
--[[
Sadness - Astronaut - Lost Soul
=_-CalmNess-_=
CRUELTY - J O Y F U L L
BEYOND - Th1rt3en
...
local modeInfo={
	...
	{Name="EMPEROR ZINYAK",Walkspeed=45,moveVal=15,Font=Enum.Font.Arcade,StrokeColor=C3.N(.5,.5,.5);Music=4558398377,LeftWing={0,BrickColor.new'Crimson'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'Crimson'.Color,Enum.Material.Neon};WingAnim='StarL'};
	{Name=" ",Walkspeed=67,moveVal=15,Font=Enum.Font.Arcade,StrokeColor=C3.N(.5,.5,.5);Music=1384066755,LeftWing={0,BrickColor.new'Crimson'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'Crimson'.Color,Enum.Material.Neon};WingAnim='StarNET'};
	...
	{Name="+UNKILLABLE+",Walkspeed=46,moveVal=13,Font=Enum.Font.Fantasy,StrokeColor=C3.N(.5,.5,.500);Music=2642108668,LeftWing={0,BrickColor.new'White'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'Crimson'.Color,Enum.Material.Neon};WingAnim='StarEL'};
	{Name="+OVERPOWERED+",Walkspeed=46,moveVal=13,Font=Enum.Font.Fantasy,StrokeColor=C3.N(.5,.5,.500);Music=3330414980,LeftWing={0,BrickColor.new'White'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'Crimson'.Color,Enum.Material.Neon};WingAnim='StarTE'};
	{Name="LEGMAN",Walkspeed=35,moveVal=15,Font=Enum.Font.Arcade,StrokeColor=C3.N(.5,.5,.500);Music=1214497430,LeftWing={0,BrickColor.new'White'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'Crimson'.Color,Enum.Material.Neon};WingAnim='StarEF'};
	...
	{Name="CRUELTY",Walkspeed=56,moveVal=15,Font=Enum.Font.Fantasy,StrokeColor=C3.N(.6,.0,.9);Music=723652641,LeftWing={0,BrickColor.new'Black'.Color,Enum.Material.Glass};RightWing={0,BrickColor.new'Black'.Color,Enum.Material.Glass};WingAnim='StarL'};
	{Name="Galaxy",Walkspeed=56,moveVal=15,Font=Enum.Font.Fantasy,StrokeColor=C3.N(.6,.0,.9);Music=1601135133,LeftWing={0,BrickColor.new'Black'.Color,Enum.Material.Glass};RightWing={0,BrickColor.new'Black'.Color,Enum.Material.Glass};WingAnim='SONUS1'};
	{Name="BEYOND",Walkspeed=16,moveVal=8,Font=Enum.Font.Arcade,StrokeColor=C3.N(0,0,0);Music=2071274388,LeftWing={0,BrickColor.new'Magenta'.Color,Enum.Material.Glass};RightWing={0,BrickColor.new'Magenta'.Color,Enum.Material.Glass};WingAnim='SONUS3'};
	{Name="ENERGY SURGE",Walkspeed=14,moveVal=8,Font=Enum.Font.Garamond,StrokeColor=C3.N(.1,.1,.1);Music=4768805003,LeftWing={0,BrickColor.new'Dark stone grey'.Color,Enum.Material.Glass};RightWing={0,BrickColor.new'Really black'.Color,Enum.Material.Glass};WingAnim={'INSANEGREG',2}};
	{Name="+DANGEROUS+",Walkspeed=64,moveVal=14,Font=Enum.Font.Gotham,StrokeColor=C3.RGB(0,190,190);Music=5513265404,LeftWing={0,BrickColor.new'Pastel light blue'.Color,Enum.Material.Glass};RightWing={0,BrickColor.new'Pastel light blue'.Color,Enum.Material.Glass};WingAnim='Sonar1'};	
	...
	{Name="HORROR",Walkspeed=16,moveVal=8,Font=Enum.Font.Arcade,StrokeColor=C3.RGB(255,152,220);Music=332387144,LeftWing={0,BrickColor.new'Crimson'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'Crimson'.Color,Enum.Material.Neon};WingAnim='NebG7'};
	{Name="Dark Matter",Walkspeed=18,moveVal=9,Font=Enum.Font.Arcade,StrokeColor=C3.RGB(255,152,220);Music=1842932918,LeftWing={0,BrickColor.new'Flame reddish orange'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'Flame reddish orange'.Color,Enum.Material.Neon};WingAnim='StarLTE'};
	{Name="REGRET",Walkspeed=21,moveVal=9,Font=Enum.Font.Arcade,StrokeColor=C3.RGB(255,152,220);Music=696691506,LeftWing={0,BrickColor.new'Flame reddish orange'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'Flame reddish orange'.Color,Enum.Material.Neon};WingAnim='StarLTR'};
	{Name="S P E E D",Walkspeed=300,moveVal=20,Font=Enum.Font.Arcade,StrokeColor=C3.RGB(255,0,220);Music=2932340879,LeftWing={0,BrickColor.new'Crimson'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'Pastel light blue'.Color,Enum.Material.Neon};WingAnim='StarA'};
	...
	--MAJORS--
	{Name="GOD OF BLADES",Walkspeed=26,moveVal=12,Font=Enum.Font.Gotham,StrokeColor=C3.RGB(255,0,0);Music=929330882,LeftWing={0,BrickColor.new'Gold'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'Gold'.Color,Enum.Material.Neon};WingAnim='StarLF'};
	{Name="MINECRAFT",Walkspeed=26,moveVal=12,Font=Enum.Font.Gotham,StrokeColor=C3.RGB(255,0,0);Music=132024343,LeftWing={0,BrickColor.new'Lime green'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'Lime green'.Color,Enum.Material.Neon};WingAnim='StarLFY'};
	{Name="OVERKILL",Walkspeed=38,moveVal=14,Font=Enum.Font.Gotham,StrokeColor=C3.RGB(255,0,0);Music=4027028379,LeftWing={0,BrickColor.new'Crimson'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'Crimson'.Color,Enum.Material.Neon};WingAnim='StarLFR'};
	...
	{Name="D O O M",Walkspeed=18,moveVal=9,Font=Enum.Font.Gotham,StrokeColor=C3.RGB(0,255,0);Music=2116461106,LeftWing={0,BrickColor.new'Crimson'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'Crimson'.Color,Enum.Material.Neon};WingAnim='StarLEP'};
	...
	{Name="ANCIENT",Walkspeed=19,moveVal=9,Font=Enum.Font.Gotham,StrokeColor=C3.RGB(255,255,0);Music=999361323,LeftWing={0,BrickColor.new'Gold'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'Fire Yellow'.Color,Enum.Material.Neon};WingAnim='StarLE'};
	...
	{Name="CRANKTON",Walkspeed=64,moveVal=15,Font=Enum.Font.Arcade,StrokeColor=C3.N(255,.9,0);Music=145897653,LeftWing={0,BrickColor.new'Really black'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'Dark stone grey'.Color,Enum.Material.Glass};WingAnim={'StarB'}};
	{Name="J O Y F U L L",Walkspeed=64,moveVal=20,Font=Enum.Font.Gotham,StrokeColor=C3.N(.4,.4,0);Music=3254085729,LeftWing={0,BrickColor.new'Cyan'.Color,Enum.Material.Glass};RightWing={0,BrickColor.new'Pink'.Color,Enum.Material.Glass};WingAnim={'StarA',10}};
	{Name="SUPERNATURAL",Walkspeed=16,moveVal=8,Font=Enum.Font.Fantasy,StrokeColor=C3.N(255,255,255);Music=2415462372,LeftWing={0,BrickColor.new'Crimson'.Color,Enum.Material.Neon};RightWing={0,BrickColor.new'Lime green'.Color,Enum.Material.Neon};WingAnim='SONUS4'};
...
UIS.InputBegan:connect(function(io,gpe)
	...
	elseif(io.KeyCode == Enum.KeyCode.Four and Mode~='BEYOND')then
		changeMode'BEYOND'
	elseif(io.KeyCode == Enum.KeyCode.Five and Mode~='ENERGY SURGE')then
		changeMode'ENERGY SURGE'
	...
	elseif(io.KeyCode == Enum.KeyCode.Q and Mode~='Dark Matter')then
		changeMode'Dark Matter'
	...
	elseif(io.KeyCode == Enum.KeyCode.T and Mode=='+OVERPOWERED+')then 
		changeMode'+UNKILLABLE+'
	...
	elseif(io.KeyCode == Enum.KeyCode.C and Mode=='Dark Matter')then
		changeMode'Mayhem'
	elseif(io.KeyCode == Enum.KeyCode.V and Mode=='Dark Matter')then
		changeMode'N U C L E A R - WASTE'
	elseif(io.KeyCode == Enum.KeyCode.E and Mode=='Dark Matter')then 
		changeMode'THE END OF WORLDS'
	elseif(io.KeyCode == Enum.KeyCode.R and Mode=='Dark Matter')then 
		changeMode'GOD OF BLADES'
	elseif(io.KeyCode == Enum.KeyCode.R and Mode=='ANCIENT')then 
		changeMode'MINECRAFT'
	elseif(io.KeyCode == Enum.KeyCode.R and Mode=='SANS')then 
		changeMode'LOVE'
	elseif(io.KeyCode == Enum.KeyCode.T and Mode=='SANS')then 
		changeMode'EMPEROR ZINYAK'
	elseif(io.KeyCode == Enum.KeyCode.T and Mode=='+DANGEROUS+')then 
		changeMode'REGRET'
	elseif(io.KeyCode == Enum.KeyCode.T and Mode=='LEGMAN')then 
		changeMode' '
	elseif(io.KeyCode == Enum.KeyCode.F and Mode=='+DANGEROUS+')then 
	...
	elseif(io.KeyCode == Enum.KeyCode.R and Mode=='GOD OF BLADES')then 
		changeMode'OVERKILL'
	elseif(io.KeyCode == Enum.KeyCode.F and Mode=='N U C L E A R - WASTE')then 
		changeMode'D O O M'
	elseif(io.KeyCode == Enum.KeyCode.F and Mode=='Dark Matter')then
		changeMode'B O U N C E ;)'
	...
	elseif(io.KeyCode == Enum.KeyCode.T and Mode=='HORROR')then
		changeMode'SUPERNATURAL'
	--TOGGLE MUSIC
...
elseif(Mode=='NEPTUNIAN V (UNEQUIPPED)')then
		...
		elseif(Mode=='CRUELTY')then
			...
			local Alpha = .1
			if(NeutralAnims)then	
				RJ.C0 = RJ.C0:lerp(RJC0*CF.N(0,13+3.05*M.C(Sine/32),0)*CF.A(M.R(-2+5*M.S(Sine/58)),M.R(-15+5*M.C(Sine/42)),0),Alpha)
				if(M.RNG(1,25)==1)then
					NK.C0 = NK.C0:lerp(NKC0*CF.A(M.RRNG(-25,25),M.RRNG(-25,25),M.RRNG(-25,25)),.8)
				else
					NK.C0 = NK.C0:lerp(NKC0*CF.A(M.R(-10-2.5*M.S(Sine/32)),M.R(35),M.R(-10))*CF.A(M.RRNG(-5,5),M.RRNG(-5,5),M.RRNG(-5,5)),Alpha)
		...
		elseif(Mode=='ENERGY')then
			local Alpha = .1
			if(NeutralAnims)then	
				RJ.C0 = RJ.C0:lerp(RJC0*CF.N(0,17+3.20*M.C(Sine/17),0)*CF.A(M.R(0+3*M.S(Sine/64)),0,0),Alpha)
				if(M.RNG(1,45)==1)then
					NK.C0 = NK.C0:lerp(NKC0*CF.A(M.RRNG(-25,25),M.RRNG(-25,25),M.RRNG(-25,25)),.8)
				else
					NK.C0 = NK.C0:lerp(NKC0*CF.A(M.R(-10-2.5*M.S(Sine/32)),0,0),Alpha)
		...
		elseif(Mode=='+DANGEROUS+')then
			...
			elseif(legAnims)then
				...
				RH.C0 = RH.C0:lerp(RHC0,Alpha)
					...
					elseif(Mode=='EMPEROR ZINYAK')then
			local Alpha = .1
			if(NeutralAnims)then
				RJ.C0 = RJ.C0:lerp(CF.N(0,4.8+.2*M.C(Sine/24),0)*CF.A(M.R(0+1*M.S(Sine/24)),M.R(.7),M.R(.4)),Alpha)
				LS.C0 = LS.C0:lerp(CF.N(-1.1,1,0.2)*CF.A(M.R(173.3+1*M.S(Sine/28)),M.R(19.9+2*M.S(Sine/28)),M.R(38.7)),Alpha)
...
if(legAnims)then 
		...
		elseif(Mode=='J O Y F U L L')then
			local Alpha = .1
			if(NeutralAnims)then	
...
if(legAnims)then 
			...
			if(legAnims)then 
				...
				elseif(Mode=='GOD OF BLADES')then
			local Alpha = .1
			if(NeutralAnims)then
			    				GotEffect{
					Lifetime=.5;
			...
			if(NeutralAnims)then
				...
				LS.C0 = LS.C0:lerp(LSC0*CF.N(.0,0+.2*M.S(Sine/32),.0)*CF.A(M.R(0),M.R(20+.50*M.C(Sine/32)),M.R(-1-1.5*M.C(Sine/32))),Alpha)
				RS.C0 = RS.C0:lerp(RSC0*CF.N(-.0,0+.2*M.S(Sine/32),.0)*CF.A(M.R(-0),M.R(20-.50*M.C(Sine/32)),M.R(1+1.5*M.C(Sine/32))),Alpha)
			end
			if(legAnims)then 
				if(NeutralAnims)then
					LH.C0 = LH.C0:lerp(LHC0*CF.N(0,0-.05*M.C(Sine/32),0)*CF.A(0,M.R(15),0),Alpha)
		...
		if(Mode=='GOD OF BLADES')then
			...
			if(legAnims)then
				...
				RH.C0 = RH.C0:lerp(CFrame.new(0.498336792, -0.303280592, -0.883536756, 1, 0, 0, 0, 0.886996508, 0.461776346, 0, -0.461776316, 0.886996448),Alpha)
				  ...
				  elseif(State == 'Walk')then
		if(Mode=='N U C L E A R - WASTE')then
			local Alpha = .1
  			if(NeutralAnims)then
  			    			    				GotEffect{
					Lifetime=.5;
